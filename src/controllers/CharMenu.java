    ...
    public void buttonClicked(Clickable clickable, Object[] args) {
        if (clickable instanceof  Button ) {
            ...
            if (button.getName().contains("magic")){
                ...
                p.setClass("mage");
                p.addToInventory(new Item("Basic Staff", new Image(10, 10, "assets" + Constants.SEP + "art" + Constants.SEP + "items" + Constants.SEP + "staff0.png"), "A basic staff"));
                //range.hide();
                //warr.hide();
                //mage.show();
               ...
               // mage.hide();
                p.setClass("ranger");
                p.addToInventory(new Item("Basic Bow", new Image(10, 10, "assets" + Constants.SEP + "art" + Constants.SEP + "items" + Constants.SEP + "bow0.png"), "A basic bow"));
               // p.printInventory();//debug
                ...
                //mage.hide();
                p.setClass("warrior");
                p.addToInventory(new Item("Basic Sword", new Image(10, 10, "assets" + Constants.SEP + "art" + Constants.SEP + "items" + Constants.SEP + "sword0.png"), "A basic sword"));
                className = "warr";
                currAnimation.stop();
