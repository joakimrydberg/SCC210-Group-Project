...
//    public final static String JRE_FONT_PATH = "C:\\Program Files\\Java\\jre" + JAVA_VERSION + "\\lib\\fonts\\";
    ...
    public final static String JDK_FONT_PATH = SEP + "home" + SEP + "josh" + SEP + "jdk" + JAVA_VERSION + SEP + "jre" + SEP + "lib"+ SEP +"fonts"+ SEP;
    public final static String JRE_FONT_PATH = "I have no idea, please don't ever ask me";
